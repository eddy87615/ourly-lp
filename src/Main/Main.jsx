...
const data = [
  ...
  },
  {
    ...
    solvedContent:
      '月1回の定例・レポーティングを実施しています。<br />社内報の閲覧状況や前月からの変化などのデータを見ながら、インナーコミュニケーション分野に携わってきたプロフェッショナルが、各担当者様や企業様が抱えていらっしゃる課題に沿って振り返りと次のアクションをご提案いたします。<br />もちろん定例以外にもお困りの際は、その都度サポートさせていただきます。',
  },
  {
