...
const data = [
  ...
  },
  {
    ...
    solvedContent:
      '月1回の定例・レポーティングを実施しています。<br />社内報の閲覧状況や前月からの変化などのデータを見ながら、インナーコミュニケーション分野に携わってきたプロフェッショナルが、<br />各担当者様や企業様が抱えていらっしゃる課題に沿って振り返りと次のアクションをご提案いたします。<br />もちろん定例以外にもお困りの際は、その都度サポートさせていただきます。<br />充実な支援体制により、継続率100%を実現しています。',
  },
  {
    ...
    content: '私はみんなの好みに合う社内報を作りたい…',
    article01: 'みんな本当に社内報読んでくれているのかを知りたい…',
    article02: '編集や印刷とか時間をかかりすぎて…',
    article03: 'みんなはどんな内容が好きですか？',
    article04: 'みんなは社内報の内容をどう思っていますか？',
    classAnnoying:
